...
class BuildReviewBuilder extends StatelessWidget {
  const BuildReviewBuilder({
    ...
    required this.personalDataCubit,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return StreamBuilder< ReviewsStates>(
      stream: ReviewsCubit.get(context).reviewsStream,
                    ...
                    child: Column(
                      children: [
                        Builder(builder: (context) {
                          ...
                          return BlocBuilder<PersonalDataCubit,
                              PersonalDataStates>(
                            builder: (context, state) {
                                    ...
                                    CircleAvatar(
                                      ...
                                      child: ClipOval(
                                        child: CachedNetworkImage(
                                          fit: BoxFit.contain,
                                          imageUrl: personalDataCubit
                                              .profileResponse!.data.doc.image,
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: List.generate(
                                            reviewCubit.reviewsResponse!.data
                                                .doc[index].rating
                                                .toInt(),
                                            (index) => Padding(
                                              padding:
